...
public class NewCauldronBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.literal("New Cauldron");
    }

    @Nullable
    @Override
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new NewCauldronBlockScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
    ...
    private void craftItem() {
        // temp recipe to test if its working
        this.removeStack(INPUT_SLOT, 1);
        ItemStack result = new ItemStack(Items.ANDESITE);
    ...
    private boolean hasRecipe() {
        // temp recipe to test if its working
        ItemStack result = new ItemStack(Items.ANDESITE);
        boolean hasInput = getStack(INPUT_SLOT).getItem() == Items.DIORITE;
